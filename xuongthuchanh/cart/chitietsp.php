...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6">
                <?php if ($product['img']) : ?>
                    <img src="<?php echo htmlspecialchars($product['img']); ?>" class="product-img h-100" alt="<?php echo htmlspecialchars($product['name']); ?>">
                <?php endif; ?>
            </div>
            <div class="col-md-6">
                ...
                <p><strong>Số lượng:</strong> <?php echo htmlspecialchars($product['stock']); ?></p>
